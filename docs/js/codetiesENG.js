...
function input(x) {
  ...
  if (document.getElementById("step2DivMain").className == "step2DivMainClass inputCheck") {
    ...
    if (document.getElementById("inputeStep2").innerHTML == "Code hier invullen" || document.getElementById("inputeStep2").innerHTML == "Try again") {
...
function step4ErrorMsg(n) {
  var errorMsgArray = [];
  errorMsgArray[0] = "Not enough space fuel, try somewhere else";
  errorMsgArray[1] = "That planet has exploded, choose a different destination";
  errorMsgArray[2] = "There is a black hole in our way, travel elsewhere first";
  errorMsgArray[3] = "We always go there, please, lets go somewhere else";
  errorMsgArray[4] = "Sorry, big brother doesn't allow visitors there";
  errorMsgArray[5] = "I have not heard of that planet";
  errorMsgArray[6] = "Upgrade to the premium space travel package to go there";
  if (n > 6) {
    return "wrong!";
  }
...
function step4CorrectCode() {
  document.getElementById("inputeStep4").style.backgroundColor = "transparent";
  document.getElementById("inputeStep4").innerHTML = "correct";
...
function step2FoutCode() {
  ...
  document.getElementById("inputeStep2").innerHTML = "Try again";
  noInputStep2(1);
  showHint();
  hintGiven = true;
}
...
function hint1() {
  ...
  document.getElementById("hintText").innerHTML = "Books contain all the knowledge you need";
  console.log("hint1");
}
...
function hint2() {
  ...
  document.getElementById("hintText").innerHTML = "The energyball is safely locked up";
  console.log("hint2");
}

function hint2Part2() {
  document.getElementById("hintText").innerHTML = "The stars have many colors";
  document.getElementById("hintButtonSecond").classList.add("hidden");
}
...
function hint3() {
  ...
  document.getElementById("mainBody").classList.remove("bodyBackground2Hint");
  document.getElementById("mainBody").classList.add("bodyBackground2HintGiven");
  document.getElementById("hintText").innerHTML = "The poster is full of interesting facts about the planets";
  console.log("hint3");
}
...
function hint4() {
  ...
  document.getElementById("mainBody").classList.remove("bodyBackground2Hint");
  document.getElementById("mainBody").classList.add("bodyBackground2HintGiven");
  document.getElementById("hintText").innerHTML = "build an escape route for the key";
  console.log("hint4");
}
...
function step2CorrectCode() {
  document.getElementById("inputeStep2").style.backgroundColor = "transparent";
  document.getElementById("inputeStep2").innerHTML = "correct";
  noInputStep2(1);
...
function step2Backspace() {
  ...
  } else if (document.getElementById("inputeStep2").innerHTML == "Code hier invullen" || document.getElementById("inputeStep2").innerHTML == "Try again") {
...
function stopTime() {
  ...
  document.getElementById("timeText").innerHTML = "Final time: ";
}
